...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		unbanlist: [
			'Solgaleo', 'Sneasler', 'Annihilape', 'Ursaluna-Bloodmoon', 'Espathra', 'Roaring Moon', 'Walking Wake', 'Dragapult'
		],
	},
	{
...
//		restricted: ['Mythical'],
	...
	},
	{
		...
		banlist: [
			...
			'Weavile', 'Zacian', 'Zacian-Crowned', 'Zamazenta', 'Zamazenta-Crowned', 'Zekrom', 'Arena Trap', 'Moody', 'Shadow Tag', 'Damp Rock', 'Heat Rock',
