...
//		restricted: ['Mythical'],
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Z-Move Clause'],
		banlist: [ 'ND OU', 'ND Uber', 'ND AG', 'ismagearnadelta', 'Baton Pass', 'Dire Claw', 'Last Respects', 'Light Clay', 'King\'s Rock', 'Quick Claw', 'Rage Fist', 'Razor Fang', 'Shed Tail',
			...
			'Metagross-Delta-Mega', 'Klocktowl-Mega', 'Flaring Quill', 'Keldeo', 'Slaughtermaus', 'Keldeo-Delta-Mega', 'Medicham-Mega', 'Archaludon', 'Molteon', 'Raichu-Mega-Y', 'Raichu-Mega-X', 'Meganium-Mega', 'Emboar-Mega',
			'Chesnaught-Mega', 'Delphox-Mega', 'Dragalge-Mega', 'Valiant Time', 'Radiant Moon', 'Gengar-Ultra', 'Diancie-Sapphire-Mega', 'Necromauser-Mega', 'Klocktowl-Mega',
		],
