...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		unbanlist: [
			'Solgaleo', 'Sneasler', 'Annihilape', 'Ursaluna-Bloodmoon', 'Espathra', 'Roaring Moon', 'Dragapult', 'Raichu-Mega-Y', 'Raichu-Mega-X', 'Absol-Mega-Z', 'Delphox-Mega', 'Greninja-Mega', 'Chesnaught-Mega', 'Absolite Z', 'Raichunite X', 'Raichunite Y', 'Greninjite', 'Chesnaughtite', 'Delphoxite'
		],
	},
	{
