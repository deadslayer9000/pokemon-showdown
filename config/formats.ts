...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		unbanlist: [
			'Solgaleo', 'Sneasler', 'Annihilape', 'Ursaluna-Bloodmoon', 'Espathra', 'Roaring Moon', 'Dragapult', 'Raichu-Mega-Y', 'Raichu-Mega-X', 'Absol-Mega-Z', 'Delphox-Mega', 'Greninja-Mega', 'Chesnaught-Mega', 'Absolite Z', 'Raichunite X', 'Raichunite Y', 'Greninjite', 'Chesnaughtite', 'Delphoxite', 'Hawlucha-Mega', 'Hawluchanite', 'Chandelure-Mega', 'Chandelurite'
		],
	},
	{
...
//		restricted: ['Mythical'],
		banlist: [ 'Alakazam-Mega', 'Magirigus', 'Slowhost', 'Maestrot', 'Melmetal', 'Magearna', 'Mewtwo', 'Eevium Z', 'Whirling Abyss', 'Rising Phoenix', 'Iron Storm', 'Iron Revival', 'Gengar-Mega', 'Kangaskhan-Mega', 'Deoxys', 'Deoxys-Attack', 'Dark Void', 'Marshadow', 'Genesect', 'Shaymin-Sky', 'Arceus', 'Darkrai'],
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Z-Move Clause'],
		banlist: [ 'ND OU', 'ND Uber', 'ND AG', 'Baton Pass', 'Dire Claw', 'Last Respects', 'Light Clay', 'King\'s Rock', 'Quick Claw', 'Rage Fist', 'Razor Fang', 'Shed Tail',
			'Serperior', 'Kartana', 'Clefable', 'Hawlucha', 'Hippowdon', 'Toxapex', 'Clodsire', 'Excadrill', 'Hoopa-Unbound', 'Skarmory', 'Cinderace', 'Venusaur', 'Garganacl', 'Iron Crown', 'Ting-Lu', 
			'Amoonguss', 'Grimmsnarl', 'Archapult', 'Iron Pilot', 'Klocktowl', 'Greninja', 'Kommo-o', 'Mawile-Mega', 'Iron Boulder', 'Armaledge', 'Dunsparath', 'Dragapult-Ultra', 'Ogerpon-Cornerstone', 'Manaphy', 'Zapdos-Galar', 'Charizard-Mega-X', 'Dragonite', 'Dondozo', 'Barraskewda', 'Slowhost', 'Ogerpon-Stormpeak', 'Klinklang-Delta','Shrookle', 'Electivisaur', 'Latios-Delta', 
			...
			'Greninja-Delta', 'Zorotales', 'Magearna-Delta', 'Spiritomb-Unbound', 'Meloetta-Omega', 'Spectreon', 'Scizantrum', 'Roserade-Delta', 'Ambipom-Ultra', 'Zeraora', 'Tapu Fini', 'Tapu Hina', 'Latios', 
			...
			'Metagross-Delta-Mega', 'Klocktowl-Mega', 'Flaring Quill', 'Keldeo', 'Slaughtermaus', 'Keldeo-Delta-Mega', 'Medicham-Mega', 'Archaludon', 
		],
	...
	},
	{
		...
		mod: 'teraoverride',
		ruleset: ['Standard OMs', 'Evasion Abilities Clause', 'Evasion Items Clause', 'Tera Type Preview', 'Standard NatDex'],
		banlist: [
			'ND Uber', 'ND AG',
