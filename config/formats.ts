...
//		restricted: ['Mythical'],
	...
	},
	{
		...
		banlist: [ 'ND OU', 'ND Uber', 'ND AG', 'Arena Trap', 'Shadow Tag', 'ismagearnadelta', 'Baton Pass', 'Dire Claw', 'Last Respects', 'Light Clay', 'King\'s Rock', 'Quick Claw', 'Rage Fist', 'Razor Fang', 'Shed Tail',
			...
			'Delphox-Mega', 'Valiant Time', 'Radiant Moon', 'Gengar-Ultra', 'Diancie-Sapphire-Mega', 'Necromauser-Mega', 'Magearna-Original-Delta', 'Chesnaught-Mega', 'Battle Bond', 'isgreninja', 
		],
