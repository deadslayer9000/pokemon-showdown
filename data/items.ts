export const Items: import("../sim/dex-items").ItemDataTable = {
	...
	flareabsovoiriumz: {
		...
		spritenum: 644,
		onTakeItem: false,
		zMove: "Perilous Divider",
		zMoveFrom: "Doomcutter",
		itemUser: ["Absovoir-Flare"],
		num: -49,
	},
	plasmaabsovoiriumz: {
	...
	boosterenergy: {
		...
		onUpdate(pokemon) {
			...
			if (
				pokemon.hasAbility("chronocatalyst") &&
				!(
					this.field.isTerrain("electricterrain") ||
					this.field.isWeather("sunnyday")
				) &&
	...
	deltaazumarilliumz: {
		...
		spritenum: 636,
		onTakeItem: false,
		zMove: "Glacial Pinion",
		zMoveFrom: "Icicle Flail",
		itemUser: ["Azumarill-Delta"],
		num: -42,
	},
	deltacharizardite: {
	...
	deltazeraoriumz: {
		...
		spritenum: 632,
		onTakeItem: false,
		zMove: "Crimson Fist Blitz",
		zMoveFrom: "Flashpoint Fists",
		itemUser: ["Zeraora-Delta"],
		num: -46,
	},
	delphoxite: {
		name: "Delphoxite",
	...
	drifblimpiumz: {
		...
		spritenum: 644,
		onTakeItem: false,
		zMove: "One-Way Journey",
		zMoveFrom: "Phantasmal Voyage",
		itemUser: ["Drifblimp"],
		num: -43,
	},
	dubiousdisc: {
	...
	manaphite: {
		name: "Manaphite",
		spritenum: 0,
		megaStone: {"Manaphy": "Manaphy-Mega"},
		itemUser: ["Manaphy"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	necromausite: {
		name: "Necromausite",
		spritenum: 577,
		megaStone: {"Necromauser": "Necromauser-Mega"},
	...
	slaughtermausite: {
		...
		spritenum: 591,
		megaStone: {"Slaughtermaus": "Slaughtermaus-Mega"},
	...
	ultraglimmoriumz: {
		name: "Ultraglimmorium Z",
		spritenum: 641,
		onTakeItem: false,
		zMove: "Wormhole Pillar",
		zMoveFrom: "Hyperspace Hole",
		itemUser: ["Glimmora-Ultra"],
		num: -45,
	},
	ultrahydrappliumz: {
		name: "Ultrahydrapplium Z",
		spritenum: 635,
		onTakeItem: false,
		zMove: "Capricious Syrup Cannonade",
		zMoveFrom: "Syrup Bomb",
		itemUser: ["Hydrapple-Ultra"],
		num: -44,
	},
	ultranecroziumz: {
