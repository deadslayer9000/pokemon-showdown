export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	flashpointfists: {
		...
		desc: "Every consecutive turn this move is used, its base power increases by 10. This can stack up to 4 times (140 base power). If this move hits a Fire type Pokemon, it gets rid of their Fire type.",
