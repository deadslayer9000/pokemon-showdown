export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	blazingswap: {
		name: "Blazing Swap",
		shortDesc: "Swaps to Blade before attacks and Shield before Infernal Shield; Immune to Fire.",
	...
	emperorwake: {
		name: "Emperor Wake",
		shortDesc: "In Rain: at the end of the turn +1 ATK.",
	},
	eternalchime: {
		name: "Eternal Chime",
	...
	fierytouch: {
		...
		desc: "Every time this Pokemon's move makes contact with an opponent, there is a 30% chance that the target will be burned.",
	},
	filter: {
		name: "Filter",
	...
	redress: {
		name: "Redress",
		shortDesc: "This Pokemon's Speed is boosted by 1 stage after being hit by a dark type attack.",
	},
	refrigerate: {
		name: "Refrigerate",
	...
	valorheart: {
		name: "Valor Heart",
		shortDesc: "Base Power of moves used by this Pokemon or its allies is multiplied by 1.2.",
	},
	vesselofruin: {
		name: "Vessel of Ruin",
